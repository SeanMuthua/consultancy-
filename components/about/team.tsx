                    ...
                    {team.map((member, index) => (
                        ...
                        >
                            ...
                            <div className={`h-64 md:h-80 w-full ${member.image} relative flex items-end p-6`}>
                                ...
                                {/* Icon Badge */}
                                <div className="absolute bottom-6 left-6 w-12 h-12 bg-[#E60000] rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg z-10">
                                    {member.icon}
                                </div>
                            </div>
                            ...
                            <div className="p-8 pt-6">
                                ...
                                <p className="text-[#E60000] text-xs uppercase tracking-widest font-bold mb-4">{member.role}</p>
