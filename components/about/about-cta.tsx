        ...
        <section className="py-32 bg-black flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                    Ready to <span className="text-[#E60000]">Shift Gears?</span>
                </h2>
                ...
                <Button className="bg-[#E60000] hover:bg-red-700 text-white h-14 px-8 text-base font-bold shadow-[0_0_20px_rgba(230,0,0,0.3)]">
                    Start Your Project
                </Button>
            </div>
        </section>
